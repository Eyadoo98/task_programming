<div>
    ...
    <script>
        ...
        var pusher = new Pusher('b592b5480b4726c6cfec', {
            cluster: 'ap1'
        });
                            ...
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-4 md:p-5">
                                        ...
                                        <button wire:click="createListTodo" type="submit"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-4">Task descriptions</th>
                            <th scope="col" class="px-4 py-4">
                                Delete
                            </th>
                            <th scope="col" class="px-4 py-4">Update</th>
                        </tr>
                        </thead>
                        <tbody>
                        @forelse($tasks as $task)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td
                                        class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <button wire:click="deleteUSerTask({{$task['id']}})" data-modal-target="popup-modal"
                                            data-modal-toggle="popup-modal"
                                            class="block text-white bg-red-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                            type="button">
                                        Delete
                                    </button>
                                ...
                                <td
                                    ...
                                    <div class="flex justify-center m-5">
                                        <button id="updateProductButton" wire:click="updateUserTask({{$task['id']}})"
    ...
    <!-- Update modal -->
    <div x-data="{ isOpen: @entangle('isModalOpenUpdate') }"
         x-show="isOpen"
         x-cloak
         @keydown.escape.window="isOpen = false"
         id="updateProductModal" tabindex="-1" aria-hidden="true"
         class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            <!-- Modal content -->
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <!-- Modal body -->
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            <label for="taskNameUpdate"
                                   class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                            <input wire:model="taskNameUpdate" type="text" name="taskNameUpdate" id="taskNameUpdate"
                    ...
                    <div class="flex items-center space-x-4">
                        <button wire:click="updateUserTaskId({{$userIdUpdate->id??''}})"
                                type="submit"
